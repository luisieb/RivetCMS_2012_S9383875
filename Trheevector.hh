...
#ifndef TRHEEVECTOR_HH_
#define TRHEEVECTOR_HH_
...
class Trheevector
{
	...
	//	constructor
	Trheevector( double x, double y , double z)
	{
		_M_x = x;
		_M_y = y;
		_M_z = z;
...
// Operadores
    ...
    Trheevector operator + (const Trheevector& v1)
    {
    	Trheevector result(0.0,0.0,0.0);
    ...
    double operator * (const Trheevector& v1)
    {
    	double result;
    ...
    Trheevector operator * (double v1)
    {
    	Trheevector result(0.0,0.0,0.0);
